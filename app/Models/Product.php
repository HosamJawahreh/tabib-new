...
class Product extends Model
{
    ...
    {
        return $this->hasMany('App\Models\ProductTranslation', 'ec_products_id');
    }
    ...
    public function translation($lang = null)
    {
        ...
        // Map Laravel locale codes to database lang_code format
        $langMap = [
            'en' => 'en_US',
            'ar' => 'ar_SA',
            '1684403411sQWZMppH' => 'en_US', // English language code from your system
            '1662525873Kynbiefk' => 'ar_SA', // Arabic language code from your system
        ];

        $dbLangCode = $langMap[$lang] ?? $lang;
    ...
    {
        $translation = $this->translation();
        return $translation ? $translation->description : $this->details;
    }

    // Get translated details/content
    public function getTranslatedDetailsAttribute()
    {
        $translation = $this->translation();
        return $translation ? ($translation->content ?: $translation->description) : $this->details;
    }
        ...
        foreach ($translations as $lang => $data) {
            if (!empty($data['name'])) {
                \App\Models\ProductTranslation::updateOrCreate(
                    ['ec_products_id' => $this->id, 'lang_code' => $lang],
                    [
                        'name' => $data['name'] ?? '',
