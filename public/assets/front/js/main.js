(function ($) {
  ...
  $(document).ready(function () {
    // Debug: confirm main.js ready
    try { console.log('[main.js] document ready - binding handlers'); } catch (e) {}
    //**************************** WISHLIST SECTION ****************************************
    ...
    $(document).on("click", ".add-cart", function (e) {
      e.preventDefault();
      try { console.log('[main.js] .add-cart clicked', $(this).data('href')); } catch (e) {}
      $.get($(this).data("href"), function (data) {
    ...
    $(document).on("click", "#addcrt", function (e) {
      ...
      try { console.log('[main.js] #addcrt clicked. pid=', pid); } catch (e) {}

      // Prevent multiple clicks
      if ($btn.hasClass('loading')) {
        try { console.log('[main.js] #addcrt already loading, ignoring click'); } catch (e) {}
        return false;
      }
    ...
    // Fallback: also bind by class in case IDs differ or markup changes
    $(document).on("click", ".add-to-cart-btn", function (e) {
      // If this element has id=addcrt the handler above already ran
      if (this.id === 'addcrt') return;
      try { console.log('[main.js] .add-to-cart-btn fallback clicked'); } catch (e) {}
    ...
    $(document).on("click", "#qaddcrt", function (e) {
      ...
      // Prevent multiple clicks
      if ($btn.hasClass('loading')) {
        try { console.log('[main.js] #qaddcrt already loading, ignoring click'); } catch (e) {}
        return false;
      }
    ...
    // Fallback: also bind by class for buy now
    $(document).on("click", ".buy-now-btn", function (e) {
      // Don't trigger if this element already has the qaddcrt ID (prevents double execution)
      if (this.id === 'qaddcrt') {
        try { console.log('[main.js] .buy-now-btn has id=qaddcrt, skipping fallback'); } catch (e) {}
        return;
      }
      try { console.log('[main.js] .buy-now-btn fallback clicked'); } catch (e) {}
      $("#qaddcrt").trigger('click');
    });
