...
// ============ SIMPLE ORDER ROUTES (NEW - GUARANTEED TO WORK) ============
Route::post('/submit-order-now', 'SimpleOrderController@submitOrder')->name('simple.order.submit');
Route::get('/order-success/{order_number}', 'SimpleOrderController@orderSuccess')->name('order.success');
// ============ END SIMPLE ORDER ROUTES ============
...
// ************************************ FRONT SECTION **********************************************
    ...
    Route::get('/products/load-more', 'Front\FrontendController@loadMoreProducts')->name('front.products.load');
    Route::get('/products/filter', 'Front\FrontendController@filterProducts')->name('front.products.filter');
...
//   Mobile Checkout section
    ...
    Route::get('/{slug}', 'Front\VendorController@index')->where('slug', '^(?!assets).*$')->name('front.vendor');
